/*
** cmd_graphic_prend.c for Za in /home/lks/rendu/PSU_2014_zappy/server
** 
** Made by Thibaud Auzou
** Login   <auzou_t@epitech.net>
** 
** Started on  Thu Jul  2 17:39:53 2015 Thibaud Auzou
** Last update Sun Jul  5 18:30:56 2015 florian hellegouarch
*/

#include "server.h"

int		cmd_graphic_prend(t_socket *s, int item)
{
  t_application	*a;
  t_list	**kase;
  int		t[7];
